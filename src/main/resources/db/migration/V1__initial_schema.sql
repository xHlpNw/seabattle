...
CREATE INDEX idx_games_room_token ON games(room_token);
...
CREATE INDEX idx_boards_game_player ON boards(game_id, player_id);
...
CREATE INDEX idx_rooms_token ON rooms(token);
